...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2022 at 07:56 PM
...
CREATE TABLE `doctors_list` (
  ...
  `syndicateCard` varchar(2000) NOT NULL,
  `avaliavleTime` datetime NOT NULL,
  `graduteDate` date NOT NULL,
  `inistaion` varchar(100) NOT NULL,
...
INSERT INTO `patient_list` (`id`, `Firstname`, `Lastname`, `username`, `gmail`, `password`, `confirmPass`, `mobile`, `Dob`, `Gender`, `Status`) VALUES
