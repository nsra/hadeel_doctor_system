...
<section class="loginSection">
    <div class="row window-full">
        ...
        <div class="col-6 float-left text-center">
           ...
           <br>
        <ul>
            <li><a href="doctor/Dlogin.php"  style="padding:10px;color:#fff; width:150px;border:none;text-transform:uppercase b" > Doctor </a></li>
           <li><a href="patient/Plogin.php "padding:10px;color:#fff;margin-left:50px;width:150px;border:none;text-transform:uppercase> patient </a></li>
        </ul>   
