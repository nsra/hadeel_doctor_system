...
$sql="update doctors_list set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,specialty_ids=:specialty_ids,img_path=:img_path,nationality=:nationality,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
