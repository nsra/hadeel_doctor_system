...
<div class="input-field "  >
    ...
    <div class="input-field " style="margin-top:20px">
        ...
        <option value="PhysicalTherapy">Physical Therapy</option>
                                            ...
                                            <div class="input-field  ">
        <?php }}?>    <center><button type="submit" name="change" style="padding:10px;color:#fff;margin:100px;width:150px;border:none;text-transform:uppercase" class="waves-effect waves-light btn indigo m-b-xs" onclick="">Save</button></center>
