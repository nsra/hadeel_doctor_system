...
$sql ="SELECT username,password,date_created,id FROM patient_list WHERE username=:uname and password=:password";
...
echo "<script type='text/javascript'> document.location = 'ho.php'; </script>";
} }
