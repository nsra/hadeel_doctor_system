...
$sql ="SELECT username,password,date_created,Status,id FROM patient_list WHERE username=:uname and password=:password";
...
if($query->rowCount() > 0)
{
 ...
 echo "<script type='text/javascript'> document.location = 'D.php'; </script>";
 } }
else{
