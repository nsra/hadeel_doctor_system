...
$sql="update doctors_list set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,specialty_ids=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
