...
<section class="loginSection">
    <div class="row window-full">
        ...
        <div class="col-6 float-left text-center">
           ...
           <br>
           <li><a href="leavehistory.php"> Doctor </a></li>
           <li><a href="leavehistory.php"> patient </a></li>

           <button class="pt-2 pb-2 pr-5 pl-5 text-center "  ></button>
           <button class="pt-2 pb-2 pr-5 pl-5 text-center bplue" > patient</button>
</div>
