...
<div class="header-content">
    <div class="logo">
       ...
       <ul class="nav">
         ...
         <li><a href="#"class="icon fa fa-user fa-2x" > LOG IN</a></li>
    ...
    <div class="home">
        <div class="overlay">
         <div class="home-content" style="text-align: center;">
             <h1 class="title">Medical Articles</h1>
             <p  style="color: #fff;">Agency provides a full service range including technical skills, design, business understanding.</p>
    ...
    <div class="container">
      <div class="blog-content">
          <div class="blog-item">
              ...
              <h6 class="blog-title">Study Uncovers Most Critical Genes That Cause Coronary Heart Disease</h6>
            ...
            <div class="blog-item mg">
                ...
                <h5 class="blog-title">Study Uncovers Most Critical Genes That Cause Coronary Heart Disease</h5>
                  </div>
    ...
    <div class="container">
      <div class="blog-content">
          <div class="blog-item">
              ...
              <h6 class="blog-title">Lorem Ipsum is simply dummy text of the printing typesetting industry.</h6>
      ...
      <button style="width: 20%; margin: 10%;  ">Load more</button> </div>
