...
<section class="loginSection">
    ...
    <input type="submit"  style="float: left;margin-left:20px;color:#fff; width:100px;height:40px;border:none;background-color:#6195ff; "name="signin" value="ignin" class="waves-effect waves-light btn teal">
