...
<body>
 ...
 <li><a href="#"class="icon fa fa-bell" >  </a></li>
   ...
   <div class="container">
                  <div class="card">
                    <div class="card-content"style="margin: 40px; ">
                           <div class="row">
                                <h1>   <a href="#" class="blog-link">  Ask For Counsel Now   </a></h1>
                                <img  style=" margin-left: 50%; width: 10%;" src="../assets/img/add.png"  > </img> 
                           </div>
