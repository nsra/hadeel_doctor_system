...
<div class="header-content">
 ...
 <li><a href="#"class="icon fa fa-bell" >  </a></li>
    ...
    <div class="section-header">
      <div class="row but" >
     <button style="width: 40%; background-color: #fff;color: #6195ff; border: #6195ff solid;"> Previous Consultations</button> 
     <button style="width: 40%; background-color: #fff; color: #000;border: #6195ff solid;margin-left: 40px;"> New Consultations</button> </div>
    </div>


   <div class="container">
                 <h3 class="blog-info">Medical Consultations:</h3>
                 <div class="card">
                    <div class="card-content"style="margin: 30px;">
                        <div class="row" >
                         <h5>Symptoms</h5>   
                         <a href="" class="fa fa-trash " style="margin-left: 80%;"></a>
                        </div>                     

              <p class="blog-desc" style="width: 80%;">A small river named Duden flows by their place and supplies it with the necessary regelialia is a paradisematic country, in which roasted parts of sentences fly into your mouth.Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic
                  ...
                  <hr>
                   <div class="row" >
                   <a href="#" class="blog-link" style="margin-top: 20px;">Dr. Abraham Pigeon answered the consultation</a>
                   <button class="" style="margin-left:70%; width: 20%;"  > See Answer</button>
