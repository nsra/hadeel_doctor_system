...
$dob=$_POST['Dob']; 
		...
		$sql = "INSERT INTO doctors_list (firstname, lastname,username, email, password,c_password,phonenumber,gender,dob ) VALUES(?,?,?,?,?,?,?,?,?)";
                        ...
                        <div class="col m6">
                            <div class="row">
                              ...
                              <div class="input-field col m6 s12 ">
                                ...
                                <input id="firstName" name="firstName"value="firstName"  placeholder="First name"  type="text" required>
                                </div>
