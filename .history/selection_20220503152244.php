...
<section class="loginSection">
    <div class="row window-full">
        ...
        <div class="col-6 float-left text-center">
           ...
           <br>
        <ul>
            <li><a href="doctor/Dlogin.php"  style="float: left;padding:10px;color:#fff; width:200px;border:none;background-color:#6195ff; " > Doctor </a></li>
           <li><a href="patient/Plogin.php "style="    display: inline-block;
    
    text-align: right;padding:10px;color:#fff; width:150px;border:none;background-color:#dce0e4;"> patient </a></li>
        </ul>   
