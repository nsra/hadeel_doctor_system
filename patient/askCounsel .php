...
<body>
 ...
 <li><a href="#"class="icon fa fa-bell" >  </a></li>
   ...
   <div class="container">
                  ...
                  <div class="card  ">
                    ...
                    <div class="card-content ">
                     <div class="header" style="position: absolute;">
                      <div class="logo">
                        <img src=" ../assets/img/log1.png"  alt="logo image" draggable="false">
                      
                     </div>
                       <ul class="nav" style="width: 50%;"> 
                            <li><a href="#"class="icon fa fa-arrow-left "style="color: #000;margin-left: 300px; " >back</a></li>
                           
                           </ul> </div> 
                    
                  <div>
                  <div class=" pd-y" style="text-align: center;">
                    <h1>
                    Talk To A Certified Doctor Now
                  </h1>  
                  <p>Add your question so that the doctor can contact you</p> 
                  ...
                  <button type="button" onclick="document.getElementById('id01').style.display='none'"style="margin:10% 10% 10% 30%; "  > New Medical Consultation</button>
