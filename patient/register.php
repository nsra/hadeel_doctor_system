 <?php
  ...
  if (isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO patient_list(Firstname, Lastname, username, email, password, confirm_pass, mobile, Dob, Gender) VALUES(?,?,?,?,?,?,?,?,?)";
    $stmtinsert = $conn->prepare($sql);
    $result = $stmtinsert->execute([$Firstname, $Lastname, $username, $email, $password, $confirm_pass, $mobile ,$Dob, $Gender]);
    if ($sql) {
     ...
     <div class="row window-full">
       ...
       <div class="col-6 float-left text-center">
         ...
         <div class="fright">
           ...
           <form action="" method="post" class="" style="align-items: center;margin-left: 50px;">
             <div class="container">
               <section>
                 <div class="wizard-content">
                   <div class="row">
                     <div class="col m6">
                       ...
                       <div class="input-field  ">
                         <input id="phone" name="mobile" style="margin:5px;" type="tel" placeholder="Mobile number" maxlength="10" autocomplete="off" required>
                       </div>
