...
if (isset($_POST['signin'])) {
  ...
  $sql = "SELECT email,password,Status,id FROM patient_list WHERE email=:email and password=:password";
  ...
  if ($query->rowCount() > 0) {
    ...
    if ($status == 0) {
      ...
      $_SESSION['palogin'] = $_POST['email'];
      echo "<script type='text/javascript'> document.location = 'Pprofile.php'; </script>";
    }
  } else {
    ...
    <div class="row window-full">
      ...
      <div class="col-6 float-left text-center">
        ...
        <div class="fright pd-y">
          ...
          <form action="./Pprofile.php" method="post" id="frmLogin">
          ...
          <div>You Don't have account yet?<a href="./register.php"> <span id="cplue">Sign up</span> </div></a>
